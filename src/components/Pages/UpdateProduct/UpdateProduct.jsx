...
const UpdateProduct = () => {
    ...
    const handleUpdateProduct = (event) => {
        ...
        fetch(`https://auto-haven-server.vercel.app/updated/${_id}`, {
            method: "PUT",
            headers: {
    ...
    return (
        <div className="max-w-screen-xl mx-auto mb-12 md:mb-20">
            <Helmet>
                <title>Auto Haven || Update Product</title>
            </Helmet>
            ...
            <div className="mx-auto  max-w-sm md:max-w-lg border-2 rounded-lg bg-[#f8f0e5b3] px-2 md:px-4 py-8">
                <form onSubmit={handleUpdateProduct}>
                    <label className="lg:text-lg font-ubuntu">
                        Select a Brand:
                    </label>
                    <select
                        defaultValue={brand}
                    ...
                    <button
                        name="submit"
                        className="btn btn-active btn-neutral w-32 block mx-auto"
                    >
                        Update
                    </button>
                </form>
